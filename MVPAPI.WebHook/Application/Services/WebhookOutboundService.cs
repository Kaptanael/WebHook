...
public class WebhookOutboundService(
    ...
    ILogger<WebhookOutboundService> logger) : IWebhookEndpointService
{
    ...
    public async Task<IReadOnlyList<WebhookOutboundResponse>> GetByClientTokenAsync(string clientToken, CancellationToken cancellationToken = default)
    {
    ...
    private static WebhookOutboundResponse ToResponse(WebhookOutbound endpoint) =>
        new(endpoint.Id,
