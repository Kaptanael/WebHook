...
{
    Task<Result<EventResponse>> PublishEventAsync(EventRequest request, string? token, string? xSignature, string? xTimestamp, CancellationToken cancellationToken = default);
